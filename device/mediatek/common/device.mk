...
#add by y.haiyang for cappu-framework
PRODUCT_PACKAGES += \
    cappu-framework
#add by y.haiyang for cappu-framework
PRODUCT_BOOT_JARS += \
...
#add by y.haiyang for cappu res
PRODUCT_PACKAGES += cappu-res
...
# for 3rd party app
# remove touchpal by lixiang 20160825 start
...
PRODUCT_PACKAGES += SpeechSettings
...
# remove touchpal by lixiang 20160825 end

# default IME
ifeq (OP01,$(word 1,$(subst _, ,$(OPTR_SPEC_SEG_DEF))))
    PRODUCT_PROPERTY_OVERRIDES += ro.mtk_default_ime =com.baidu.input_spec.ImeService
endif
...
ifeq ($(strip $(MAGCOMM_LAUNCHERWIN_SUPPORT)),yes)
  PRODUCT_PACKAGES += LauncherWin
  PRODUCT_PACKAGES += CappuNewsHealth
else
  PRODUCT_PACKAGES += Launcher3
endif
#hejianfeng add end 
...
ifeq ($(strip $(CAPPU_KEYGUARD_PICTORIAL)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.com.cappu.keyguard.pictorial=1
  PRODUCT_PACKAGES += CappuPictorial
endif
# end: edit by hmq 20161108 Modify for cappu pictorial

# begin: edit by hmq Modify for CleanedrManager
ifeq ($(strip $(CAPPU_CLEANEDR_MANAGER)),yes)
  PRODUCT_PACKAGES += CleanedrManager
endif
# end: edit by hmq Modify for CleanedrManager


# zhouhua  add IShare begin
ifeq ($(strip $(CAPPU_ISHARE_SUPPORT)),yes)
  PRODUCT_PACKAGES += IShare
endif
# zhouhua  add IShare  end

# zhouhua add DZH begin
ifeq ($(strip $(CAPPU_DZH_SUPPORT)),yes)
  PRODUCT_PACKAGES += DZH
endif
# zhouhua add DZH end

# zhouhua add MagcommCalendar begin
ifeq ($(strip $(CAPPU_CALENDAR_SUPPORT)),yes)
	PRODUCT_PACKAGES += CappuCalendar
endif
# zhouha add MagcommCalendar end

# zhouhua add InternetNavigation begin
ifeq ($(strip $(CAPPU_INTERNET_NAVIGATION)),yes)
  PRODUCT_PACKAGES += InternetNavigation
endif
# zhouhua add InternetNavigation end

# zhouhua add DownLoadCenter begin
ifeq ($(strip $(DOWNLOADCENTER_APP_SUPPORT)),yes)
  PRODUCT_PACKAGES += DownloadCenter
endif
# zhouhua add DownLoadCenter end

# zhouhua  add CaiYiDaDao begin
ifeq ($(strip $(CAPPU_CAIYIDADAO_SUPPORT)),yes)
  PRODUCT_PACKAGES += CaiYiDaDao
endif
# zhouhua  add CaiYiDaDao  end

# zhouhua add SOS begin
ifeq ($(strip $(CAPPU_SOS_SUPPORT)),yes)
  PRODUCT_PACKAGES += SOS
endif
# zhouhua add SOS end

# zhouhua add I99ReadMe begin
ifeq ($(strip $(CAPPU_I99README_SUPPORT)),yes)
  PRODUCT_PACKAGES += I99ReadMe
endif
# zhouhua add I99ReadMe end

#zhouhua add 2345browser begin
ifeq ($(strip $(CAPPU_2345BROWSER_SUPPORT)),yes)
  PRODUCT_PACKAGES += 2345browser
endif
#zhouhua add 2345browser end 

# zhouhua add cappu care  begin
ifeq ($(strip $(CAPPU_CAPPU_CARE_SUPPORT)),yes)
  PRODUCT_PACKAGES += cappu_care
endif
# zhouhua add cappu care end


# zhouhua add weixin begin
ifeq ($(strip $(CAPPU_WEIXIN_SUPPORT)),yes)
  PRODUCT_PACKAGES += weixin
endif
# zhouhua add weixin end

#zhouhua add QrcodeScanner begin
ifeq ($(strip $(CAPPU_QRCODE_SCANNER)),yes)
  PRODUCT_PACKAGES += QrcodeScanner
endif
#zhouhua add QrcodeScanner end

#zhouhua add FileExplorer begin
ifeq ($(strip $(CAPPU_FILEEXPLORER_SUPPORT)),yes)
  PRODUCT_PACKAGES +=FileExplorer
endif
#zhouhua add FileExplorer end

# zhouhua add Magnifiter begin
ifeq ($(strip $(CAPPU_MAGNIFITER_SUPPORT)),yes)
  PRODUCT_PACKAGES += Magnifiter
endif
# zhouhua add Magnifiter end
#zhouhua add bootanim begin
ifeq ($(strip $(CAPPU_BOOTANIM_SUPPORT)),yes)
  PRODUCT_PACKAGES += bootanim
endif
#zhouhua add bootanim end
#zhouhua add BaiduInput begin
ifeq ($(strip $(CAPPU_BAIDUINPUT_SUPPORT)),yes)
  PRODUCT_PACKAGES += Baiduinput
endif
#zhouhua add BaiduInput end
#hejianfeng add start for cappu weather
PRODUCT_PACKAGES += CappuWeather
#hejianfeng add end for cappu weather

#hejianfeng add start for cappuMusic
PRODUCT_PACKAGES += CappuMusic

#dengying add CIT begin
ifeq ($(strip $(CAPPU_CIT_SUPPORT)),yes)
  PRODUCT_PACKAGES += CIT
endif
#dengying add CIT end
#zhouhua add HealthCenter begin
ifeq ($(strip $(CAPPU_HEALTHCENTER_SUPPORT)),yes)
  PRODUCT_PACKAGES += HealthCenter
endif
#zhouhua add HealthCenter end
#zhouhua add BaiduSearch begin
ifeq ($(strip $(CAPPU_BAIDUSEARCH_SUPPORT)),yes)
  PRODUCT_PACKAGES += BaiduSearch
endif
#zhouhua add BaiduSearch end
#zhouhua add CappuNaQuBa begin
ifeq ($(strip $(CAPPU_CAPPUNAQUBA_SUPPORT)),yes)
  PRODUCT_PACKAGES += CappuNaQuBa
endif
#zhouhua add CappuNaQuBa end
#zhouhua add CappuHelper begin
ifeq ($(strip $(CAPPU_CAPPUHELPER_SUPPORT)),yes)
  PRODUCT_PACKAGES += CappuHelper
endif
#zhouhua add CappuHelper end
#zhouhua add CappuHelper1 begin
ifeq ($(strip $(CAPPU_CAPPUHELPER1_SUPPORT)),yes)
  PRODUCT_PACKAGES += CappuHelper1
endif
#zhouhua add CappuHelper1 end
#zhouhua add AppCollection begin
ifeq ($(strip $(CAPPU_APPCOLLECTION_SUPPORT)),yes)
  PRODUCT_PACKAGES += AppCollection
endif
#zhouhua add AppCollection end
# hejianfeng add for hall
ifeq ($(strip $(MAGCOMM_HALL_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.magcomm_hall_support=1
  PRODUCT_PACKAGES += HallLockScreen
endif
#zhouhua  add bootaudio begin
ifeq ($(strip $(CAPPU_BOOTAUDIO_SUPPORT)),yes)
  PRODUCT_PACKAGES +=Bootaudio
endif
#zhouhua  add bootaudio end
#zhouhua  add TencentMobileAssistant  begin
ifeq ($(strip $(CAPPU_TENCENTMOBILEASSISTANT_SUPPORT)),yes)
  PRODUCT_PACKAGES +=TencentMobileAssistant
endif
#zhouhua  add  TencentMobileAssistant  end
#zhouhua  add DeskClockCappu begin
ifeq ($(strip $(CAPPU_DESKCLOCKCAPPU_SUPPORT)),yes)
  PRODUCT_PACKAGES +=DeskClockCappu
endif
#zhouhua  add DeskClockCappu end
#zhouhua  add DeskClockCappu begin
ifeq ($(strip $(CAPPU_DESKCLOCKCAPPU_SUPPORT)),yes)
  PRODUCT_PACKAGES +=DeskClockCappu
endif
...
#zhouhua  add CalculatorCappu begin
ifeq ($(strip $(CAPPU_CALCULATORCAPPU_SUPPORT)),yes)
  PRODUCT_PACKAGES +=CalculatorCappu
endif
#zhouhua  add CalculatorCappu end

#zhouhua add DuDiZhu begin
ifeq ($(strip $(CAPPU_DOUDIZHU_SUPPORT)),yes)
  PRODUCT_PACKAGES +=DouDiZhu
endif
#zhouhua add DuDiZhu end

#zhouhua add HuanLeMaJiang begin
ifeq ($(strip $(CAPPU_HUANLEMAJIANG_SUPPORT)),yes)
  PRODUCT_PACKAGES +=HuanLeMaJiang
endif
#zhouhua add HuanLeMaJiang end

#zhouhua add JunQi begin
ifeq ($(strip $(CAPPU_JUNQI_SUPPORT)),yes)
  PRODUCT_PACKAGES +=JunQi
endif
#zhouhua add JunQi end

#zhouhua add WuZiQi begin
ifeq ($(strip $(CAPPU_WUZIQI_SUPPORT)),yes)
  PRODUCT_PACKAGES +=WuZiQi
endif
#zhouhua add WuZiQi end

#zhouhua add ZhongGuoXiangQi begin
ifeq ($(strip $(CAPPU_ZHONGGUOXIANGQI_SUPPORT)),yes)
  PRODUCT_PACKAGES +=ZhongGuoXiangQi
endif
#zhouhua add ZhongGuoXiangQi end

#zhouhua add MassageDevice begin
ifeq ($(strip $(CAPPU_MASSAGEDEVICE_SUPPORT)),yes)
  PRODUCT_PACKAGES +=MassageDevice 
endif
#zhouhua add MassageDevice end
#by opitimizeBoot 20170815 begin
ifeq ($(TARGET_BUILD_VARIANT),user)
	WITH_DEXPREOPT := true
	WITH_DEXPREOPT_PIC := true
endif
# by opitimizeBoot 20170815 end

#jiangyan add Healthmanage begin
ifeq ($(strip $(CAPPU_HEALTHMANAGE_SUPPORT)),yes)
  PRODUCT_PACKAGES +=Healthmanage 
endif
#jiangyan add Healthmanage end
#zhouhua add 20170818 BaiduMap begin
ifeq ($(strip $(CAPPU_BAIDUMAP_SUPPORT)),yes)
  PRODUCT_PACKAGES +=BaiduMap
endif
#zhouhua add 20170818 BaiduMap end
#zhouhua add 20170818 QQMusic begin
ifeq ($(strip $(CAPPU_QQMUSIC_SUPPORT)),yes)
  PRODUCT_PACKAGES +=QQMusic
endif
#zhouhua add 20170818 QQMusic end
#zhouhua add 20170818 TDsquareDance begin
ifeq ($(strip $(CAPPU_TDSQUAREDANCE_SUPPORT)),yes)
  PRODUCT_PACKAGES +=TDsquareDance
endif
#zhouhua add 20170818 TDsquareDance end
#zhouhua add 20170825 XiMaFM begin
ifeq ($(strip $(CAPPU_XIMAFM_SUPPORT)),yes)
  PRODUCT_PACKAGES +=XiMaFM
endif
#zhouhua add 20170825 XiMaFM end
#zhouhua add 20170902 TencentVideo begin
ifeq ($(strip $(CAPPU_TENCENTVIDEO_SUPPORT)),yes)
  PRODUCT_PACKAGES +=TencentVideo
endif
#zhouhua add 20170902 TencentVideo end
